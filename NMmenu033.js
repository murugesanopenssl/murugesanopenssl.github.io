...
//							(htmlFileName === "Tamilnadu-MLA.html" && activeLink.textContent.trim() === "Tamil Nadu MLAs") ||
							...
							(htmlFileName === "itr-steps-to-submit-at-india.html" && activeLink.textContent.trim() === "ITR Filing Steps") ||
							...
							(htmlFileName === "Bharath_gas_booking_steps.html" && activeLink.textContent.trim() === "Bharat Gas") ||
							(htmlFileName === "how-to-know-sim-number.html" && activeLink.textContent.trim() === "Find SIM Number") ||
							(htmlFileName === "Set-Black-Image-lock-screen-home-screen.html" && activeLink.textContent.trim() === "Samsung Wallpaper") ||
							(htmlFileName === "steps-to-port-jio-to-bsnl.html" && activeLink.textContent.trim() === "Port Jio to BSNL") ||
							(htmlFileName === "Indian-Oil-Cylinder-Booking-Online-Steps.html" && activeLink.textContent.trim() === "Indian Oil") ||
				...
				<LI class="nav-item">
					...
					<UL class="submenu">
						<LI class="nav-item">
							...
							<UL class="submenu">
								<LI>
									<A href="#" onclick="javascript:loadHomeContent( event, 'itr-steps-to-submit-at-india.html' );" class="nav-link">ITR Filing Steps</A>
								</LI>
								<LI>
