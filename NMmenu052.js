...
{
		location_url=window.location.href="https://murugesanopenssl.github.io/index.html";
}
...
{
	document.write( "<TR><TD valign='top' style='width:95px;' align='left'><TABLE style='width:100%'><TR><TD style='width:72px;' id='homepage' valign='top' align='left'><A style='display:block;' onmouseover='OpenHomeMenu()' onclick='OpenHomeMenu()' href='https://murugesanopenssl.github.io/index.html'>Home1 page</A></TD></TR></TABLE>");
	document.getElementById('homepage').style.backgroundColor='violet';
}
else if( ( -1 != My_Drawings_url_01 ) || ( -1 != My_Drawings_url_02 ) )
{
	document.write( "<TR><TD valign='top' style='width:95px;' align='left'><TABLE style='width:100%'><TR><TD style='width:72px;' id='homepage' valign='top' align='left'><A style='display:block;' onmouseover='OpenHomeMenu()' onclick='OpenHomeMenu()' href='https://murugesanopenssl.github.io/index.html'>Home2 page</A></TD></TR></TABLE>");
...
document.write( "<TABLE style='width:100%'><TR><TD valign='top' align='left'><A style='display:block;' onmouseover='OpenHealthTips()' onclick='OpenHealthTips()' id='healthtips01'>HealthTips</A></TD></TR></TABLE>");
...
if( -1 != inhale_hotwater_ent_url )
{
	...
	document.getElementById('healthtips01').style.backgroundColor='violet';
...
{
	document.write( "<A href='https://murugesanopenssl.github.io/spending.html'>Do not waste money</A>");
}
